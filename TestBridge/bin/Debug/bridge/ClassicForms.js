    ...
    Bridge.define("System.Windows.Forms.MessageBox", {
        statics: {
            methods: {
                 ...
                 * @static
                 * @public
                 * @this System.Windows.Forms.MessageBox
                 * @memberof System.Windows.Forms.MessageBox
                 * @param   {string}    message    Chuỗi thông điệp
                 * @return  {void}
                 */
                Show: function (message) {
                    ...
                    var fontSize = 15;
                    var messageboxId = "gdf235";
                    var MessageBoxForm = ($t = new System.Windows.Forms.Form(), $t.Text = "Thông báo", $t.Size = ($t1 = new System.Drawing.Size.ctor(), $t1.Width = 323, $t1.Height = MessageBoxHeight, $t1), $t.MaximizeBox = false, $t.MinimizeBox = false, $t);


                    var MessageHolder = ($t = new System.Windows.Forms.Label(), $t.ForeColor = System.Drawing.Color.Green.$clone(), $t.Name = System.String.format("{0}_txtMessage", [messageboxId]), $t.Text = System.String.format("{0}", [message]), $t.Font = new System.Drawing.Font.ctor("San Serif", fontSize), $t.Dock = System.Windows.Forms.DockStyle.Fill, $t);

                    var bottomPanel = ($t = new System.Windows.Forms.Panel(), $t.Dock = System.Windows.Forms.DockStyle.Bottom, $t.Height = bottomPanelHeight, $t.Visible = true, $t);
                    var btnClose = ($t = new System.Windows.Forms.Button(), $t.Text = "Đóng", $t.Height = bottomPanelHeight, $t.Width = 50, $t.Visible = true, $t);
                    ...
                    MessageBoxForm.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;

                    MessageBoxForm.addLoad(function (sender, evt) {
    ...
    Bridge.define("System.Windows.Forms.Label", {
        ...
        props: {
            ...
            Size$1: {
                set: function (value) {
                    alert("");
                    this.Element.style.width = value.Width + "pt";
                    this.Element.style.width = value.Height + "pt";
                }
            }
        },
        ctors: {
    ...
    Bridge.define("System.Windows.Forms.Form", {
        ...
        props: {
            ...
            Text: {
                ...
                set: function (value) {
                    this._title = value;
                    this._htmlTitle.innerHTML = value;
                }
            }
        },
        ctors: {
            ...
            ctor: function () {
                ...
                this._htmlTitle = this.CreateFormWindowsTitle();
                //WinFormButtonSide
        ...
        methods: {
            ...
            CreateFormWindowsTitle: function () {
                this._htmlTitle = document.createElement("div");
                this._htmlTitle.style.marginTop = "-23px";
                this._htmlTitle.style.marginLeft = "10px";
                this._htmlTitle.style.fontSize = "15px";
                this._htmlTitle.style.color = "white";
                this._htmlTitle.style.cssFloat = "left";
                this.Element.appendChild(this._htmlTitle);
