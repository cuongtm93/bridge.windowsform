...
namespace System.Windows.Forms
{
    public class Form : ContainerControl
    {
        ...
        private HTMLDivElement _htmlTitle;
        ...
        {            
            ...
            _htmlTitle = CreateFormWindowsTitle();
            //WinFormButtonSide
        ...
        public virtual HTMLDivElement CreateFormWindowsTitle()
        {
            _htmlTitle = new HTMLDivElement();
            _htmlTitle.style.marginTop = "-23px";
            _htmlTitle.style.marginLeft = "10px";
            _htmlTitle.style.fontSize = "15px";
            _htmlTitle.style.color = "white";
            _htmlTitle.style.cssFloat = "left";
            Element.appendChild(_htmlTitle);
            return _htmlTitle;
        }
